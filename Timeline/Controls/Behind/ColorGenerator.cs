...
namespace YL.Timeline.Controls.Behind
{
	...
	{
		private static readonly Dictionary<string, Color> _statesColors = new Dictionary<string, Color>();

		internal static Color GetColor(string state)
		{
			Color result;
			if (_statesColors.TryGetValue(state, out result))
			{
				return result;
			}
